...
void godot::GameScene::_on_enter() {
...
void godot::GameScene::_on_update(double delta_time) {
...
void godot::GameScene::_bind_methods() {
  // DO NOT bind _on_enter, _on_exit, or _on_update here!
  
  ClassDB::bind_method(D_METHOD("get_update_underneath"), &GameScene::get_update_underneath);
